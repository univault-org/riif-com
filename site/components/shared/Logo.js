...
export default function Logo({ className = "" }) {
  // Enhanced sparkle variants with bigger glow
  const sparkleVariants = {
    shine: {
      scale: [1, 1.4, 1],
      opacity: [0.8, 1, 0.8],
      filter: ["drop-shadow(0 0 3px #B45309)", "drop-shadow(0 0 8px #B45309)", "drop-shadow(0 0 3px #B45309)"],
      transition: {
        duration: 2,
        repeat: Infinity,
        ease: "easeInOut"
  ...
  // Enhanced dot variants with bigger sparkles
  const dotVariants = {
    shine: (i) => ({
      scale: [1, 1.5, 1],
      opacity: [0.7, 1, 0.7],
      filter: [
        "drop-shadow(0 0 2px #B45309)",
        "drop-shadow(0 0 5px #B45309)",
        "drop-shadow(0 0 2px #B45309)"
      ],
      transition: {
        duration: 1.5,
        ...
        <span className="relative mx-[2px] inline-flex items-center">
          ...
          >
            <span className="relative">
              {/* Golden J letter */}
              <span 
                className="absolute -left-3 -top-[1.5rem] text-2xl font-bold text-amber-500 dark:text-yellow-400"
                style={{
                  filter: 'drop-shadow(0 0 1px rgba(180, 83, 9, 0.5))',
              ...
              <div className="absolute -top-8 -left-3.5">
                <svg
                  ...
                  className="w-6 h-6"
                >
                  {/* Larger sparkle dots positioned around the J */}
                  {[
                    { cx: 8, cy: 4 },    // top right
